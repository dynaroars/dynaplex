...
extern int initstate_r(unsigned int __seed, char *__restrict __statebuf, size_t __statelen, struct random_data *__buf) ;
extern int setstate_r(char *__restrict __statebuf, struct random_data *__buf);
